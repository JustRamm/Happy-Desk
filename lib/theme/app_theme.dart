...
class AppTheme {
  // Brand Colors strictly matching Design System Style Guide Image
  static const Color primary = Color(0xFFFF6B35); // #FF6B35 Vibrant Warm Orange
  ...
  static const Color secondary = Color(0xFFFF99C8); // #FF99C8 Soft Pink
  static const Color secondaryContainer = Color(0xFFFF99C8);
  static const Color onSecondaryContainer = Color(0xFF7B2C56);

  static const Color tertiary = Color(0xFF00C49A); // #00C49A Vibrant Emerald Teal
  static const Color tertiaryContainer = Color(0xFF00C49A);
  static const Color onTertiaryContainer = Color(0xFF00392B);

  static const Color neutral = Color(0xFF2D3142); // #2D3142 Dark Slate / Charcoal
  static const Color onSurface = Color(0xFF2D3142);
  static const Color onSurfaceVariant = Color(0xFF4A4E69);
  ...
  // Mappings for UI Components & Icons
  static const Color primaryRust = Color(0xFFFF6B35);
  static const Color primaryRustDark = Color(0xFFD94D18);
  static const Color primaryRustLight = Color(0xFFFFF0EB);
  static const Color titleDark = Color(0xFF2D3142);
  static const Color textSecondary = Color(0xFF4A4E69);
  static const Color textMuted = Color(0xFF8D7168);
  static const Color brandTitleOrange = Color(0xFFFF6B35);
  static const Color pinkBadgeBg = Color(0xFFFFF0F7);
  static const Color pinkIconBg = Color(0xFFFFE0F0);
  static const Color pinkIconColor = Color(0xFFFF99C8);
  static const Color mintBadgeBg = Color(0xFFE6FAF5);
  static const Color mintIconBg = Color(0xFFB8F3E5);
  static const Color mintIconColor = Color(0xFF00C49A);
  static const Color progressTrack = Color(0xFFFFE0D4);
  ...
  // Typography Styles (Plus Jakarta Sans for Headlines, Be Vietnam Pro for Body/Labels)
