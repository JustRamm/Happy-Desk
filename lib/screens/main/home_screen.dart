...
import '../coffee/leave_history_screen.dart';
import '../ngl/ngl_jar_screen.dart';
import '../ngl/compose_ngl_screen.dart';
import '../hero/hero_appreciation_screen.dart';
import 'work_session_screen.dart';
...
import '../mochi/sounding_board_screen.dart';
import '../founder/founder_analytics_screen.dart';
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const SoundingBoardScreen(),
                ),
              );
            },
            child: Container(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const WorkSessionScreen(),
          ),
        );
      },
      child: Container(
                  ...
                  OutlinedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const FounderAnalyticsScreen(),
                        ),
                      );
                    },
              ...
              OutlinedButton.icon(
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          const NglJarScreen(showBackButton: true),
                    ),
                  );
                },
                icon: const Icon(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // CTA Button to open HeroAppreciationScreen
                SizedBox(
                  width: double.infinity,
                  height: 48,
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const HeroAppreciationScreen(showBackButton: true),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
