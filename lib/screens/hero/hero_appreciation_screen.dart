...
class HeroAppreciationScreen extends StatefulWidget {
  final bool showBackButton;

  const HeroAppreciationScreen({super.key, this.showBackButton = false});

  @override
  State<HeroAppreciationScreen> createState() => _HeroAppreciationScreenState();
}

class _HeroAppreciationScreenState extends State<HeroAppreciationScreen> with SingleTickerProviderStateMixin {
