...
class CoffeeBreakScreen extends StatefulWidget {
  final Map<String, dynamic>? initialTeammate;

  const CoffeeBreakScreen({
    super.key,
    this.initialTeammate,
  });

  @override
  State<CoffeeBreakScreen> createState() =>
      _CoffeeBreakScreenState();
}

class _CoffeeBreakScreenState
    extends State<CoffeeBreakScreen> {
