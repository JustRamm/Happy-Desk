...
class SoundingBoardScreen extends StatefulWidget {
  const SoundingBoardScreen({super.key});

  @override
  State<SoundingBoardScreen> createState() =>
      _SoundingBoardScreenState();
}

class _SoundingBoardScreenState
    extends State<SoundingBoardScreen> {
