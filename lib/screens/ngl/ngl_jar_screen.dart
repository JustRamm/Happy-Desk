...
class NglJarScreen extends StatefulWidget {
  final bool showBackButton;

  const NglJarScreen({super.key, this.showBackButton = false});

  @override
  State<NglJarScreen> createState() => _NglJarScreenState();
}

class _NglJarScreenState extends State<NglJarScreen> {
                    ...
                    return _buildOpenedNoteCard(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => NglDetailScreen(
