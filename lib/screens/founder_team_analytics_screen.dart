...
class FounderTeamAnalyticsScreen extends StatefulWidget {
  const FounderTeamAnalyticsScreen({super.key});

  @override
  State<FounderTeamAnalyticsScreen> createState() =>
      _FounderTeamAnalyticsScreenState();
}

class _FounderTeamAnalyticsScreenState
    extends State<FounderTeamAnalyticsScreen> {
